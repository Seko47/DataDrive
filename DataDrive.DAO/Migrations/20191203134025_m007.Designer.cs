...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataDrive.DAO.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "8be03a7f-bf8d-4044-9a45-5ea2680ca273",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9efd6e5d-042c-44a0-adc5-9c94ec2055c3",
                            Email = "admin@admin.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@ADMIN.COM",
                            NormalizedUserName = "ADMIN@ADMIN.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEHnnTR/IYFORJvN/LKrqOlASPNLFIl7K/Ul9tPutH3e4yVQD177rbOOSQgBg/r/xqg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c7cd8dce-53e1-49dc-a1e1-448270c49540",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "9a88f6e9-fd77-4ce0-b56b-b474f6e90f89",
                            ConcurrencyStamp = "5e25a0b1-378b-400a-9c61-50806326f013",
                            Name = "admin",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "8be03a7f-bf8d-4044-9a45-5ea2680ca273",
                            RoleId = "9a88f6e9-fd77-4ce0-b56b-b474f6e90f89"
                        });
                });
            ...
            modelBuilder.Entity("DataDrive.DAO.Models.ShareEveryone", b =>
                {
                    b.HasOne("DataDrive.DAO.Models.Base.FileAbstract", "Resource")
            ...
            modelBuilder.Entity("DataDrive.DAO.Models.ShareForUser", b =>
                {
                    b.HasOne("DataDrive.DAO.Models.Base.FileAbstract", "Resource")
                        ...
                        .HasConstraintName("FK_ShareAbstracts_FileAbstracts_ResourceID1")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
